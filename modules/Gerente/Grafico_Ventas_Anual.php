...
class Grafico_Ventas_Anual
{
    ...
    function Regresa_Imagen()
    {
        ...
        $xml="<chart palette='1' showBorder='1' caption='Comparación de ventas: objetivos contra real por año".$nm_subprograma."' showValues='0' decimals='0' formatNumberScale='0' yAxisMinValue='0' yAxisMaxValue='100' exportEnabled='1' exportAtClient='1' exportHandler='fcExporter".$contador_div."c' exportType='PNG=Exportar como imagen'><categories>";
    ...
    function Regresa_Tabla()
    {
        ...
        $buf.="<th>Totales</th></tr></thead><tbody><tr heigth='30'  class='row2'><td>Objetivos de ventas</td>";
        $total_anual=0;
        ...
        $buf.="<td align='right'>".number_format($total_anual,0)."</td></tr><tr  heigth='30' class='row1'><td>Ventas
reales</td>";
        $ventas_anual=0;
        foreach($this->array_anos as $ano_id => $value)
        {
        ...
        $buf.="<td align='right'>".number_format($ventas_anual,0)."</td></tr><tr  heigth='30' class='row2'><td>Porcentaje</td>";
        $promedio_anual=0;
