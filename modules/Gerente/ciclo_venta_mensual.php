...
global $db, $uid,$mes_id,$_site_name,$_includesdir,$_modulesdir,$buffer,$buffer_ventas,$buffer_semaforo,$ano_id,$_site_title;
...
$_site_title = "Objetivos y ciclo de venta-SFG0010";
